...
# Note that with the usage of a preset, we pass many different options to CMake.
  ...
  CMAKE_INSTALL_PREFIX:PATH="<your-build-install-dir>"
...
-- Conan: Found program <your-conan>/Scripts/conan.exe
-- Conan: Version found Conan version 1.47.0
-- Conan executing: conan install .. --remote conancenter --build missing --options webready=True --settings arch=x86_64 --settings build_type=Release --settings compiler=Visual Studio --settings compiler.version=17 --settings compiler.runtime=MD
...

# CMake finds the project dependencies which were automatically handled by conan
-- Conan: Using autogenerated FindZLIB.cmake
-- Library zlib found <your-conan-cache>/zlib/1.2.11/_/_/package/
-- Conan: Using autogenerated FindCURL.cmake
-- Library libcurl_imp found <your-conan-cache>/libcurl/7.79.0/_/_/package/
...

# CMake finish the project configuration and prints a report
-- Install prefix:    <your-build-install-dir>
-- ------------------------------------------------------------------
-- CMake Generator:   Ninja
-- CMAKE_BUILD_TYPE:  Release
-- Compiler info: MSVC <your-MSVC-toolset-path>/cl.exe ; version: 19.30.30705.0
...
--
...
-- Build files have been written to: <your-build-dir>
```
